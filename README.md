...
![Login Screen](https://github.com/diyorbekshokirov/login_ui/blob/main/assets/scren/scren.png)
...
1. Clone the repository: git clone https://github.com/diyorbekshokirov/login_ui.git
